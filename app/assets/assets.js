...
// Function to generate a random date for orders within the last year
const getRandomDate = () => {
  const now = new Date();
...
export const mockOrders = [
  {
    _id: "order_001",
    userId: "user_abc", // Assuming a user ID for later authentication
    orderDate: getRandomDate().toISOString(),
    totalAmount: 220.00,
    status: "Delivered",
    shippingAddress: {
      street: "123 Main St",
    ...
    items: [
      ...
      },
      {
        ...
        price: 20.00, // Reduced for this example
        size: "S",
        quantity: 1
      }
    ]
  ...
  {
    _id: "order_003",
    userId: "user_xyz", // A different user's order
    orderDate: getRandomDate().toISOString(),
    totalAmount: 110.00,
    status: "Shipped",
    shippingAddress: {
